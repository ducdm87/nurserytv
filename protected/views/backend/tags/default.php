<div class="row">
    <div class="col-md-12"><h1>Danh sách Tags</h1></div>
    <div class="col-lg-4 col-md-6 col-xs-12 col-sm-12">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form action="<?php echo $this->createUrl('tags/add'); ?>" method="post">
                            ...
                            <?php if (isset($lists) && $lists): ?>
                                ...
                                <?php foreach ($lists as $item): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo $this->createUrl('/tags?id=' . $item['id']) ?>" role="edit"><i class="fa fa-edit"> Sửa</i></a>
                                            ||
                                            <a href="<?php echo $this->createUrl('/tags/delete?id=' . $item['id']) ?>"><i class="fa fa-times"></i> Xóa</a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php endforeach; ?>
