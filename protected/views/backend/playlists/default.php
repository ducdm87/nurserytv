            ...
            <table class="adminlist" cellpadding="1">
                <thead> 
                    <tr>
                        ...
                        <th class="title" width="3%"> <a>Items</a></th>                
                ...
                <tbody>
                    ...
                    foreach ($items as $i => $item) {
                        $link_edit = $this->createUrl('playlists/edit', array("cid" => $item['id']));   
                        $item['slug'] = $item['id']."-".$item['alias'];
                        $params = urlencode(json_encode( array("id"=>$item['slug']) ));

                        $link_view = "/goto.php?control=playlists&action=detail&params=$params";               
                        $link_items = $this->createUrl('videos/', array("filter_playlistID" => $item['id']));
                        ?>
                        <tr class="row1">
                            <td><?php echo ($i + 1); ?></td>
