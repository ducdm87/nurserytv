        ...
        <div class="paging">
            <ul class="pagination">
                ...
                for ($j = 1; $j <= $pages_total; $j++) {
                    ...
                    if ($j == $pages_current) {
                        ?>
                        <li class="pagenav-active active">
                ...
                if ($pages_current < $pages_total) {
                    ...
                    ?>
                    <li class="pagenav-inactive active">
                        <a href="?limitstart=<?php echo ("$_limitstart"); ?>" onclick="javascript: document.adminForm.limitstart.value =<?php echo ("$_limitstart"); ?>;
                                            submitform();
                                            return false;"> > </a>
                    </li>
                            ...
                            <div class="news-items">
                                <?php foreach ($items as $item): ?>
                                    <div class="col-md-3 no-padding">
                                        <div class="thumbnail">
                                            <a href="<?php echo Yii::app()->baseUrl . '/tin-tuc?id=' . $item['id'] . '&alias=' . $item['alias'] ?>">
                                                <img src="<?php echo $item['thumbnail'] ?>" alt=""/>
                                            </a>
                                            <div class="caption">
                                                <p>
                                                    <a href="<?php echo Yii::app()->baseUrl . '/tin-tuc?id=' . $item['id'] . '&alias=' . $item['alias'] ?>"><?php echo $item['title'] ?></a>    
                                                </p>
                                            </div>
                                        </div>
